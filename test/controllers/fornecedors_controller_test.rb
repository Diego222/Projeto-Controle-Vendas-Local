...
class FornecedorsControllerTest < ActionController::TestCase
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post :create, fornecedor: { cep: @fornecedor.cep, cidade: @fornecedor.cidade, empresa: @fornecedor.empresa, endereco: @fornecedor.endereco, estado: @fornecedor.estado, fax: @fornecedor.fax, telefone: @fornecedor.telefone }
    end
  ...
  test "should update fornecedor" do
    patch :update, id: @fornecedor, fornecedor: { cep: @fornecedor.cep, cidade: @fornecedor.cidade, empresa: @fornecedor.empresa, endereco: @fornecedor.endereco, estado: @fornecedor.estado, fax: @fornecedor.fax, telefone: @fornecedor.telefone }
    assert_redirected_to fornecedor_path(assigns(:fornecedor))
  end
